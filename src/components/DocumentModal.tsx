...
export default function DocumentModal({ isOpen, onClose, type }: DocumentModalProps) {
  ...
  const renderPrivacyContent = () => (
    <div className="policy-content">
      <p className="policy-intro">
        <strong>TaskFlow</strong>(이하 '본 서비스')은(는) 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
      </p>
      ...
      <section className="policy-section">
        ...
        <p>② <strong>파기 방법</strong>: 전자적 파일 형태로 기록·저장된 개인정보는 기록을 재생할 수 없도록 파기(DB 영구 삭제)하며, 종이 문서는 분쇄하거나 소각하여 파기합니다.</p>
      </section>
      ...
      <section className="policy-section">
        ...
        <ol>
          ...
          <li><strong>해킹 등에 대비한 기술적 대책</strong>: 보안 인증을 획득한 전문 클라우드 플랫폼(Google Firebase)을 기반으로 운영되며, 전 구간 보안 통신(HTTPS)을 사용하여 데이터를 암호화하여 전송합니다.</li>
      ...
      <section className="policy-section">
        ...
        <ul className="officer-info">
          <li><strong>성명</strong>: 나혜진 (개발 교사)</li>
          <li><strong>소속</strong>: 서울원광초등학교</li>
          <li><strong>직위</strong>: 교사</li>
          <li><strong>연락처</strong>: [학교 교무실 번호] (※ 개인정보보호를 위해 교사의 개인 휴대전화 번호는 기재하지 않습니다.)</li>
        </ul>
      </section>
  ...
  const renderTermsContent = () => (
    <div className="policy-content">
      <p className="policy-intro">
        본 이용약관(이하 '약관')은 서울원광초등학교 나혜진 교사(이하 '서비스 제공자')가 제공하는 교육용 웹 애플리케이션 서비스 <strong>TaskFlow</strong>(이하 '본 서비스')의 이용에 관한 사항을 규정합니다.
      </p>

      <section className="policy-section">
        <h3>제1조 (목적)</h3>
        <p>이 약관은 서비스 제공자가 제공하는 무료 교육용 웹 애플리케이션 서비스(이하 '서비스')를 이용함에 있어 서비스 제공자와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
      </section>

      <section className="policy-section">
        <h3>제2조 (정의)</h3>
        <ol>
          <li><strong>'서비스'</strong>란 본 플랫폼에서 제공하는 교육용 웹 애플리케이션(TaskFlow)을 말합니다.</li>
      ...
      <section className="policy-section">
        <h3>제5조 (서비스의 중단)</h3>
        <ol>
          <li>본 서비스는 시스템 점검, 교체 및 고장, 통신 두절 등의 사유가 발생한 경우에는 서비스의 제공을 일시적으로 중단할 수 있습니다.</li>
          <li>본 서비스는 무료로 제공되는 교육용 서비스이므로, 서비스 중단으로 인한 별도의 보상은 제공되지 않습니다.</li>
        </ol>
      </section>
      ...
      <section className="policy-section">
        ...
        <ol>
          ...
          <li>만 14세 미만의 아동은 학교 가정통신문 등을 통해 보호자(법정대리인)의 동의를 받은 후 서비스를 이용할 수 있습니다.</li>
        </ol>
      </section>
      ...
      <section className="policy-section">
        <h3>제9조 (저작권)</h3>
        <ol>
          <li>본 서비스가 작성한 저작물에 대한 저작권은 서비스 제공자에게 귀속합니다.</li>
          <li>이용자는 서비스를 이용하여 얻은 정보를 서비스 제공자의 사전 승낙 없이 복제, 송신, 출판, 배포하여서는 안 됩니다.</li>
        </ol>
      </section>
      ...
      <section className="policy-section">
        <h3>제10조 (면책조항)</h3>
        <ol>
          <li>본 서비스는 무료로 제공되는 교육용 서비스로서, 서비스 이용 중 발생하는 기술적 문제나 오류에 대해 제한적 책임을 집니다.</li>
          <li>본 서비스가 연결하는 외부 웹 애플리케이션의 내용에 대해서는 해당 애플리케이션 제공자가 책임을 집니다.</li>
        </ol>
      </section>
